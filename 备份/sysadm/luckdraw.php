...

{
   ...
   $start_time = local_strtotime($_POST['start_time']);
    ...
    if ($exc->edit("goods_id='$_POST[goods_id]', title='$_POST[title]', start_time='$start_time', end_time='$end_time',stock_num='$_POST[stock_num]',content='$_POST[content]' ", $_POST['id']))
...

{
    ...
    $sql = "INSERT INTO ".$hhs->table('luckdraw')." (title,goods_id,stock_num,start_time, end_time,content)



    VALUES ('$name','$goods_id','$num','$start_time','$end_time','$content')";
