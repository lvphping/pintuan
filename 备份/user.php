...
if ($action == 'luckdraw')
{
    ...
    $record_count = $db->getOne("SELECT COUNT(*) FROM " .$hhs->table('order_info'). "as o left join ".$hhs->table('luckdraw')." as l on o.luckdraw_id = l.id WHERE o.user_id = '$user_id' and o.pay_status >1 and o.luckdraw_id > 0".$where);
...

{
	...
	$smarty->display("user_refund.dwt");
