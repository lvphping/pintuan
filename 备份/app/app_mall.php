...
$sort  = !empty($_REQUEST['sort']) ? trim($_REQUEST['sort']) : 'sort_order';
$size  = !empty($_REQUEST['page_size']) ? intval($_REQUEST['page_size']) : 20;

$order = '';
$site_id  = $_REQUEST['site_id'];
$children = get_children($cat_id);
$count = get_mall_goods_count($children,$site_id);
...
$goodslist = get_mall_goods($children, $size, $page, $sort, $order,$site_id);
