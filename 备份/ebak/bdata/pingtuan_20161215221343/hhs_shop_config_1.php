...
E_D("replace into `hhs_shop_config` values('101','1','shop_name','text','','','小舍拼团系统微营销版V6.0','1');");
E_D("replace into `hhs_shop_config` values('102','1','shop_title','text','','','小舍拼团系统微营销版V6.0','1');");
E_D("replace into `hhs_shop_config` values('103','1','shop_desc','text','','','小舍拼团系统微营销版V6.0','1');");
E_D("replace into `hhs_shop_config` values('104','1','shop_keywords','text','','','小舍拼团系统微营销版V6.0','1');");
E_D("replace into `hhs_shop_config` values('116','1','shop_closed','select','0,1','','0','1');");
E_D("replace into `hhs_shop_config` values('117','1','close_comment','textarea','','','小舍拼团系统微营销版V6.0','1');");
...
E_D("replace into `hhs_shop_config` values('306','999','image_width','text','','','640','1');");
E_D("replace into `hhs_shop_config` values('307','999','image_height','text','','','640','1');");
...
E_D("replace into `hhs_shop_config` values('314','999','comments_number','text','','','4','1');");
...
E_D("replace into `hhs_shop_config` values('319','999','page_size','text','','','10','1');");
...
E_D("replace into `hhs_shop_config` values('324','999','goods_gallery_number','text','','','5','1');");
...
E_D("replace into `hhs_shop_config` values('423','4','stock_dec_time','select','1,0','','1','1');");
...
E_D("replace into `hhs_shop_config` values('908','9999','sms_password','password','','','7h4364','0');");
E_D("replace into `hhs_shop_config` values('907','9999','sms_name','text','','','59008','0');");
E_D("replace into `hhs_shop_config` values('1010','1','remind_info','textarea','','','货物已准备好，请速来领取','1');");
E_D("replace into `hhs_shop_config` values('911','6','default_shipping_id','hidden','','','91','1');");
E_D("replace into `hhs_shop_config` values('115','1','service_phone','text','','','400-029-2635','1');");
E_D("replace into `hhs_shop_config` values('105','1','shop_country','manual','','','1','1');");
E_D("replace into `hhs_shop_config` values('106','1','shop_province','manual','','','16','1');");
E_D("replace into `hhs_shop_config` values('107','1','shop_city','manual','','','222','1');");
E_D("replace into `hhs_shop_config` values('108','1','shop_address','text','','','碑林区文艺北路金色城市','1');");
E_D("replace into `hhs_shop_config` values('912','0','share_info','group','','','','1');");
E_D("replace into `hhs_shop_config` values('913','912','index_share_title','text','','','昊海拼团微营销版，移动电商营销利器！','1');");
...
E_D("replace into `hhs_shop_config` values('919','1','group_purchase','text','','','2','1');");
E_D("replace into `hhs_shop_config` values('920','1','team_suc_time','text','','','1','1');");
E_D("replace into `hhs_shop_config` values('921','1','affirm_received_time','text','','','2','1');");
E_D("replace into `hhs_shop_config` values('922','1','subscribe_url','text','','','http://mp.weixin.qq.com/s?__biz=MzI5NTA4Nzg5NQ==&mid=2650983727&idx=1&sn=abe12270db3fd97037a175c08f015d1e#rd','1');");
...
E_D("replace into `hhs_shop_config` values('923','1','qr_code','file','','../images/','../images/6.jpg','1');");
E_D("replace into `hhs_shop_config` values('924','1','min_money','text','','','0.01','1');");
E_D("replace into `hhs_shop_config` values('925','1','percentage','text','','','0','1');");
E_D("replace into `hhs_shop_config` values('928','1','ziti','select','0,1','','1','1');");
E_D("replace into `hhs_shop_config` values('929','1','bonus_ad','textarea','','','我们的理想就是为您省下每一分\r\nhttp://www.aikf.com/ask/h5/g.htm','1');");
E_D("replace into `hhs_shop_config` values('930','1','shop_logo','file','','../themes/{\$template}/images/','../themes/haohainew/images/logo.gif','1');");
...
E_D("replace into `hhs_shop_config` values('939','1','qq','text','','','http://chat.weiliaokefu.com/mobile-index-cid-4902','1');");
...
E_D("replace into `hhs_shop_config` values('944','1','y_pos','text','','','510','1');");
...
E_D("replace into `hhs_shop_config` values('948','1','share_img','file','','../images/','../images/未标题-6.png','1');");
...
E_D("replace into `hhs_shop_config` values('1000','999','index_show_team_num','text','','','5','1');");
E_D("replace into `hhs_shop_config` values('1001','999','index_show_mall_num','text','','','20','1');");
...
E_D("replace into `hhs_shop_config` values('1008','912','shb_title','text','','','昊海软件为您发放好友券','1');");
