...
if ($act == 'default'){
	...
	*/
	...
	$results['stores_info'] =$stores_info;
	...
	foreach($rands_goods as $ix=>$vv)
	{
		$rands_goods[$ix]['goods_img'] = $redirect_uri.$vv['goods_img'];
		
	}
	$results['rands_goods'] =$rands_goods;
    ...
    foreach ($goods_list AS $key => $value)
    {
		...
		$goods_list[$key]['subtotal']     = $redirect_uri.$value['goods_thumb'];
