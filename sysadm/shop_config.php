...
if ($_REQUEST['act'] == 'list_edit') {
    ...
    if (!empty($_POST['invoice_rate'])) {
        ...
        $invoice = array('type' => $_POST['invoice_type'], 'rate' => $_POST['invoice_rate']);
...
function get_settings($groups = null, $excludes = null)
{
    ...
    /* 取出全部数据：分组和变量 */
    $sql = "SELECT * FROM " . $hhs->table('shop_config') . " WHERE type<>'hidden' {$config_groups} {$excludes_groups} ORDER BY parent_id, sort_order, id";
