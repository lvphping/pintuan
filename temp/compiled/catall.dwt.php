    ...
    <div class="searchbox">
        <div class="search">
            <form id="searchForm" name="searchForm" method="get" action="search.php" onSubmit="return checkSearchForm()">
                ...
                <input name="keywords" id="keyword" type="text" class="index-search-input" placeholder="搜索商品" onclick="openSearch();">
...
?> <a href="mall.php?cid=<?php echo $this->_var['cat_two']['id']; ?>"><img src="<?php if ($this->_var['cat_two']['cat_img']): ?><?php echo $this->_var['site_url']; ?><?php echo $this->_var['cat_two']['cat_img']; ?><?php else: ?><?php echo $this->_var['site_url']; ?>images/no_picture.gif<?php endif; ?>"><span><?php echo $this->_var['cat_two']['name']; ?></span></a> <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?> </dd>
            <?php endif; ?>
            <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
            <?php $_from = $this->_var['category']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'cat');if (count($_from)):
    foreach ($_from AS $this->_var['cat']):
