...
<div class="container" id="container" style="display:none;">
    <div class="topbox" style="background-color: rgba(255,255,255,0); box-shadow: 0 0 0px rgba(0,0,0,0);">
        <header class="index-header" style="background-color: rgba(255,255,255,0);"> 
            <div class="city_txt" style="display:none;"><a href="javascript:void(0);"><i class="iconfont icon-weizhi"></i><b><?php echo $this->_var['site_name']; ?></b></a> </div>
...
$(function(){
    $(window).scroll(function(){
        if($(window).scrollTop()>40){
            $(".index-header").css({"background-color":"rgba(201,21,35,0.7)"});
        } else {
   ...
   document.getElementById("leftTime"+key).innerHTML =a + b + c + d; //显示倒计时信息
    ...
    <div class="swiper-container" style="/*margin-top:56px;*/">
        <div class="swiper-wrapper">
		    <?php $_from = $this->_var['banner']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'banner_0_93673500_1498453966');if (count($_from)):
    foreach ($_from AS $this->_var['banner_0_93673500_1498453966']):
?>
            <div class="swiper-slide"><a href="<?php echo $this->_var['banner_0_93673500_1498453966']['ad_link']; ?>"><img src="<?php echo $this->_var['banner_0_93673500_1498453966']['ad_code']; ?>" width="100%"/></a></div>
...
?>
        ...
        <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
		<?php $_from = get_advlist_position_name(首页5图_4小图,5); if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'ad');if (count($_from)):
    foreach ($_from AS $this->_var['ad']):
?>
		<li><a href="<?php echo $this->_var['ad']['url']; ?>"><img src="<?php echo $this->_var['ad']['image']; ?>"></a></li>
        <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
